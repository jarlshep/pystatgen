...
class TestTexttoHTML(unittest.TestCase):
    ...
    def test_image(self):
        node = TextNode("This is alt text for an image", TextType.IMAGE, "public/src/hello.jpg")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {'src': 'public/src/hello.jpg', 'alt': 'This is alt text for an image'})
